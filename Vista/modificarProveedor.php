            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                      <!-- FORM ACTUALIZAR -->
                      <form class="form-horizontal form-label-left" action="../Controlador/UpdateProveedor.php" method="POST">
                        <span class="section">Editar Proveedor</span>
                        <?php
                          if (!empty($_GET['id'])) {
                             # code...
                            $ID = $_GET['id'];
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="NombreProv" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="NombreProv" placeholder="Jon Doe" required="required" type="text" value="<?php echo $DATA['nombre']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="NitProv" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="NitProv" required="required" type="text" value="<?php echo $DATA['nit']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="NumProv" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="NumProv" required="required" type="text" value="<?php echo $DATA['numeroAutorizacion']; ?>">
                          </div>
                        </div>
