            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                      <!-- FORM ACTUALIZAR -->
                      <form class="form-horizontal form-label-left" action="../Controlador/UpdateEmpresa.php" method="POST">
                        <span class="section">Editar Empresa</span>
                        <?php
                          if (!empty($_GET['id'])) {
                             # code...
                            $ID = $_GET['id'];
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="nombreEmpres" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nombreEmpres" required="required" type="text" value="<?php echo $DATA['nombreEmpresa']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="nitEmpres" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nitEmpres" required="required" type="text" value="<?php echo $DATA['nit']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="hidden" id="telefono" name="id" placeholder="73738238" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" value="<?php echo $DATA['idEmpresa']; ?>">
                          </div>
                        </div>
