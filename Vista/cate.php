...
<html lang="en">
  <head>
    ...
    <link href="../vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
     ...
     <link href="../Vista/css/bootstrap-theme.min.css" rel="stylesheet">
     <link href="../Vista/css/bootstrapValidator.css" rel="stylesheet">
     <link href="../Vista/css/bootstrapValidator.min.css" rel="stylesheet">
     <link href="../Vista/css/bootstrapValidator.scss" rel="stylesheet">
  
     <link rel="stylesheet" href="../Vista/css/bootstrap.css"/>

      <link rel="stylesheet" href="../Vista/css/demo.css"/>
      <link rel="stylesheet" href="../Vista/css/bootstrapValidator.css"/>

      <script type="text/javascript" src="../Vista/jquery/jquery-1.10.2.min.js"></script>
      <script type="text/javascript" src="../Vista//js/bootstrap.min.js"></script>
      <script type="text/javascript" src="../Vista/js/bootstrapValidator.js"></script>
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  <div class="x_content">
                      ...
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Lista Categorías</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Crear Categoría</a>
                        </li>
                      ...
                      <div id="myTabContent" class="tab-content">
                            ...
                            <tbody>
                               ...
                               <?php 
                                               ...
                                               <tr>
                                                 ...
                                                 <th scope="row"><?php echo $row ["Ice"];?></th>
                                                 <td>
                                                     <div class="btn-group">
                                                          ...
                                                          <ul class="dropdown-menu" role="menu">
                                                            ...
                                                            <li><a href="modificarCategoria.php?id=<?php echo $row ['idCategoria'];?>">Editar</a>
                                                            </li>

                                                             <li class="divider"></li>
                                                            <li><a onclick="eliminar(<?php echo $row ['idCategoria'];?>)";>Dar de baja</a>
                                                            </li>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                          ...
                          <div class="x_content">
                              ...
                              <form id="usuarios" class="form-horizontal form-label-left" action="../Controlador/CategoriaControlador.php" method="POST">
                              ...
                              <span class="section">Nuevo Categoría</span>
                                ...
                                <div class="item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="nombreCategoria"  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nombreCategoria"  required="required" type="text">
                                  </div>
                                </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
      $('#nombreCategoria').bootstrapValidator({
