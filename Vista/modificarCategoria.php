                ...
                <div class="x_panel">
                  <div class="x_content">
                      ...
                      <form class="form-horizontal form-label-left" action="../Controlador/UpdateCategoria.php" method="POST">
                        <span class="section">Editar Categoría</span>
                        <?php
                          if (!empty($_GET['id'])) {
                             # code...
                            $ID = $_GET['id'];
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                               <select id="nombreImpuesto" name="nombreImpuesto" class="form-control" value>
                                <option value="0"><?php echo $DATA['nombre']; ?></option>
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="hidden" id="telefono" name="id" placeholder="73738238" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" value="<?php echo $DATA['idImpuesto']; ?>">
                          </div>
                        </div>
