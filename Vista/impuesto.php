                                  ...
                                  <div class="x_content">
                                    ...
                                    <table class="table table-striped">
                                      ...
                                      <tbody>
                                               ...
                                               $getAll = mysql_query($queryImpuesto);
                                               ...
                                               <tr>
                                                 ...
                                                 <td>
                                                   <td class="center">
                                                            <a class="btn btn-info btn-xs" href="modificarImpuesto.php?id=<?php echo $row ['idImpuesto'];?>">
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="../Controlador/ImpuestoControlador.php" method="POST" id="imp">
