...
<html lang="en">
  ...
  <body class="nav-md">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i>Inventario <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="">Administrar Proveedor</a></li>
                ...
                <div class="x_panel">
                  <div class="x_content">
                      ...
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Modificar Proveedor</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Crear Nuevo Proveedor</a>
                        </li>
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                          ...
                          <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                               ...
                               $getAll = mysql_query($queryProveedor);
                               while ($row = mysql_fetch_array($getAll, MYSQLI_ASSOC)):
                               ?>
                               <tr>
                                 <th scope="row"><?php echo $row ["nombre"];?></th>
                                 <td><?php echo $row ['nit'];?> </td>
                                  <td><?php echo $row ['estado'];?><span class="glyphicon glyphicon-ok"></span> </td>
                                 ...
                                 <td>
                                     <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li><a href="modificarProveedor.php?id=<?php echo $row ['idProveedor'];?>">Editar</a>
                                            </li>

                                             <li class="divider"></li>
                                            <li><a onclick="eliminar(<?php echo $row ['idProveedor'];?>)";>Eliminar</a>
                                            </li>
                    ...
                    <form class="form-horizontal form-label-left" action="../Controlador/ProveedorControlador.php" method="POST">
                      
                    <span class="section">Nuevo Proveedor</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nombre <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="nameProveedor" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nombreProveedor"  required="required" type="text">
                        </div>
                      </div>
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="nitProveedor" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nitProveedor" required="required" type="text">
                        </div>
                      </div>
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Numero de autorización <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="numAutorizacion" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="numAutorizacion"  required="required" type="text">
                        </div>
                      </div>
    ...
    <script type="text/javascript">
      $("#nameProveedor").keyup(function(e) {
      // Our regex
   ...
   <script type="text/javascript">
     ...
     <script type="text/javascript">
      $("#numAutorizacion").keyup(function(e) {
      // Our regex
      // a-z => allow all lowercase alphabets
      // A-Z => allow all uppercase alphabets
      // 0-9 => allow all numbers
