            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                      <!-- FORM ACTUALIZAR -->
                      <form class="form-horizontal form-label-left" action="../Controladores/UpdateProducto.php" method="POST">
                        <span class="section">Editar Producto</span>
                        <?php
                          if (!empty($_GET['id'])) {
                             # code...
                            $ID = $_GET['id'];
                        ...
                        ?>
                                    ...
                                    <div class="item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="nombreProducto" class="form-control col-md-7 col-xs-12" data-validate-length-range="30" data-validate-words="2" name="nombreProducto"  required="required" type="text" value="<?php echo $DATA['nombre']; ?>">
                                      </div>
                                    </div>
                                     <div class="item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="desProd" class="form-control col-md-7 col-xs-12" data-validate-length-range="20" data-validate-words="2" name="desProducto"  required="required" type="text" value="<?php echo $DATA['descripcion']; ?>">
                                      </div>
                                    </div>
                                     <div class="item form-group">
                                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Fecha de expiración <span class="required">*</span>
                                           ...
                                           <input type="date" name="fecha" id="fecha" required="required" value="<?php echo $DATA['fechaExpiracion']; ?>">
                                          </div>
                                    </div>
                                    <div class="item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="codigoProd" name="codigoProducto" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $DATA['codigo']; ?>">
                                      </div>
                                    </div>
                                     <div class="item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                              ...
                                              <select id="nombreCat" name="nombreCat">
                                     ...
                                     <div class="item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="stockProd" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" data-validate-words="2" name="stockProd" required="required" type="text" value="<?php echo $DATA['cantidadStock']; ?>">
                                      </div>
                                    </div>
                                     <div class="item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="precioVenta" class="form-control col-md-7 col-xs-12" data-validate-length-range="3" data-validate-words="2" name="precioVenta"  required="required" type="text" value="<?php echo $DATA['precioVenta']; ?>">
                                      </div>
                                    </div>
                                   <!--Insertar foto-->
                                   ...
                                   <div class="item form-group">
                                      ...
                                      <input id="imagen" name="imagen" type="file" value="<?php echo $DATA['foto']; ?>" />
                                  </div>
