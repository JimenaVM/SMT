                ...
                <div class="x_panel">
                  <div class="x_content">
                      ...
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Modificar Empresa</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Crear Nueva Empresa</a>
                        </li>
                    ...
                    <span class="section">Nueva empresa</span>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="nombreEmpresa" class="form-control col-md-7 col-xs-12" data-validate-length-range="10" data-validate-words="2" name="nombreEmpresa"  required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="nitEmpresa" class="form-control col-md-7 col-xs-12" data-validate-length-range="13" data-validate-words="2" name="nitEmpresa"  required="required" type="text">
                        </div>
                      </div>
