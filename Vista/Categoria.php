                ...
                <div class="x_panel">
                  <div class="x_content">
                      ...
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Lista de impuestos actuales</a>
                        </li>
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="../Controlador/CategoriaControlador.php" method="POST" id="imp">
